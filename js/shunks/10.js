...
/* harmony import */ var _coreui_utils_src__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @coreui/utils/src */ "./node_modules/@coreui/utils/src/index.js");
...
var ChartBarSimple = function ChartBarSimple(props) {
  ...
  var defaultDatasets = function () {
    return [{
      data: dataPoints,
      backgroundColor: Object(_coreui_utils_src__WEBPACK_IMPORTED_MODULE_2__["getColor"])(backgroundColor),
      pointHoverBackgroundColor: Object(_coreui_utils_src__WEBPACK_IMPORTED_MODULE_2__["getColor"])(pointHoverBackgroundColor),
      label: label,
      barPercentage: 0.5,
...
var ChartLineSimple = function ChartLineSimple(props) {
  ...
  var defaultDatasets = function () {
    return [{
      data: dataPoints,
      borderColor: Object(_coreui_utils_src__WEBPACK_IMPORTED_MODULE_2__["getColor"])(borderColor),
      backgroundColor: Object(_coreui_utils_src__WEBPACK_IMPORTED_MODULE_2__["getColor"])(backgroundColor),
      pointBackgroundColor: Object(_coreui_utils_src__WEBPACK_IMPORTED_MODULE_2__["getColor"])(pointHoverColor),
      pointHoverBackgroundColor: Object(_coreui_utils_src__WEBPACK_IMPORTED_MODULE_2__["getColor"])(pointHoverColor),
      label: label
    }];
  }();
  ...
  var computedDatasets = function () {
    return Object(_coreui_utils_src__WEBPACK_IMPORTED_MODULE_2__["deepObjectsMerge"])(defaultDatasets, attributes.datasets || {});
  }();

  var computedOptions = function () {
    return Object(_coreui_utils_src__WEBPACK_IMPORTED_MODULE_2__["deepObjectsMerge"])(defaultOptions, attributes.options || {});
  }(); // render
