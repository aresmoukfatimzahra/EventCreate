...
var User = /*#__PURE__*/function (_Component) {
  ...
  function User(props) {
    ...
    _this.componentDidMount = function () {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("api/user/".concat(id, "/show")).then(function (Response) {
        _this.setState({
          user: Response.data
        });
  ...
  _createClass(User, [{
    ...
    value: function render() {
      ...
      var userDetails = Object.entries(this.state.user); // [['id', (<span><CIcon className="text-muted" name="cui-icon-ban" /> Not found</span>)]]
      ...
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tbody", null, userDetails !== null ? userDetails.map(function (_ref, index) {
